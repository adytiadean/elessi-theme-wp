...
if ($cross_sells) :
    ...
    if (isset($_REQUEST['nasa_action']) && $_REQUEST['nasa_action'] === 'nasa_after_add_to_cart') {
        ...
        $end_row = '</div>';
        $class_wrap .= ' larger-12 columns margin-top-50';
    }
    ...
    $class_slider .= $heading ? '' : ' nasa-slick-nav nasa-nav-box-shadow';
    ...
    <div class="<?php echo esc_attr($class_wrap); ?>">
        <?php if ($heading) : ?>
            <div class="nasa-slide-style-product-carousel nasa-relative">
