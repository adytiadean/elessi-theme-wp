...
if (NASA_WOO_ACTIVED) {
    ...
    class Elessi_WC_Widget_Price_Filter extends WC_Widget {
        ...
        public function widget($args, $instance) {
            ...
            $instance['title'] = isset($instance['title']) ? $instance['title'] : esc_html__('Price', 'elessi-theme');
            $instance['btn_filter'] = isset($instance['btn_filter']) ? $instance['btn_filter'] : 0;

            if (!is_shop() && !is_product_taxonomy()) {
                echo '<div id="' . $args['widget_id'] . '-ajax-wrap" class="nasa-hide-price nasa-filter-price-widget-wrap" data-instance="' . esc_attr(json_encode($instance)) . '" data-args="' . esc_attr(json_encode($args)) . '">' .
            ...
            $res = '<div id="' . $args['widget_id'] . '-ajax-wrap" class="nasa-filter-price-widget-wrap" data-instance="' . esc_attr(json_encode($instance)) . '" data-args="' . esc_attr(json_encode($args)) . '">';
                ...
                '<form method="get" action="' . esc_url($form_action) . '">' .
                    '<div class="price_slider_wrapper">' .
                        ...
                        '<div class="price_slider_amount">' .
                            ...
                            ($instance['btn_filter'] ? '<button type="submit" class="button nasa-transition right rtl-left nasa-filter-price-btn">' . esc_html__('Filter', 'elessi-theme') . '</button>' : '') .
                        '</div>' .
                    '</div>' .
