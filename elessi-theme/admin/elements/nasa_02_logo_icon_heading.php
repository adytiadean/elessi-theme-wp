...
if (!function_exists('elessi_logo_icon_heading')) {
    function elessi_logo_icon_heading() {
        ...
        $of_options[] = array(
            "name" => esc_html__("Height - Logo Mibile", 'elessi-theme'),
        ...
        $of_options[] = array(
            "name" => esc_html__("Width - Logo Mobile", 'elessi-theme'),
        ...
        $of_options[] = array(
            "name" => esc_html__("Height - Logo Sticky", 'elessi-theme'),
        ...
        $of_options[] = array(
            "name" => esc_html__("Width - Logo Sticky", 'elessi-theme'),
