...
$('body').on('click', '.nasa-start-import.selected', function() {
    if (!$(this).hasClass('processing')) {
        ...
        _clear_time_out = setInterval(function () {
            ...
            /**
             * Igrone
            if ($('.plugins-installed').find('.ins-error').length) {
                var _url = $('.plugins-installed').attr('data-url_manual');
                var _err = $('.plugins-installed').attr('data-text_error');
                $('.plugins-installed').append('<li class="nasa-label-plg ins-error"><a href="' + _url + '">' + _err + '</a></li>');
